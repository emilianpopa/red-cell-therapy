  ...
  const testimonials = [
    {
      ...
      testimonial: "The red light therapy has been a game-changer for my recovery routine. I feel more energized and focused.",
    },
    {
      name: "Isaac",
      role: "Radiologist",
      testimonial: "As a medical professional, I appreciate the science-backed approach. The results speak for themselves.",
    },
    {
      name: "Sarah",
      role: "Athlete",
      testimonial: "Recovery times have improved significantly. I can train harder and bounce back faster.",
    },
  ];
